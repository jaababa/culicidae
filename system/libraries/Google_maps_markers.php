...
class CI_Google_maps_markers {
    ...
    var $origin_lat	      	= 46.25413079;       // The latitude origin at which we show the map
	var $origin_lng	      	= -72.12170362;       // The longitude origin at which we show the map
    ...
    */
	...
	function create_map($markers)
	{
		if ( ($markers[1]['lat'] == NULL) or ($markers[1]['lng'] == NULL) ) { //if there is a defined marker
            ...
            $image_path = $this->CI->config->item('default_image_path'); // default path where images are stored
