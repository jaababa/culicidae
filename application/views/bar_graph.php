...
<head>
	...
	<a href='index.php/viewers/graph_data_bar?id=<?php echo $this->input->get('id'); ?>startmonth=<?php echo $this->input->get('startmonth') ?>&endmonth=<?php echo $this->input->get('endmonth')?>&year=<?php echo $this->input->get('year') ?>&region_id=<?php echo $this->input->post('cities') ?>' rel="facebox"><b style='color: red;font-size: 14px;'>BAR GRAPH</b></a> -
	
	<a href='index.php/viewers/graph_data?id=<?php echo $this->input->get('id'); ?>&startmonth=<?php echo $this->input->get('startmonth') ?>&endmonth=<?php echo $this->input->get('endmonth')?>&year=<?php echo $this->input->get('year') ?>&region_id=<?php echo $this->input->post('cities') ?>' rel="facebox"><b>line graph</b></a>
	<script type="text/javascript">
		$(function() {
