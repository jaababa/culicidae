...
{	
	var longitude = getElementById("longitude").value;
	var latitude = getElementById("latitude").value;
	if (IsNumeric(longitude) == false)
		return false; 
	if (IsNumeric(latitude) == false)
		return false;
	return true;
}
...
<tr>
<td colspan="2" class="td_top td_bottom" align="center"><h3 style="font-family:sans-serif;">ADD NEW SCHOOLS FOR REGION</h3></td>
</tr>
<tr align="center">
<td colspan="2" class="td_top">
<body class="body">
<form id="theform" method="post" action="<?php echo base_url(); ?>index.php/administrator/add_school">
...
<td class="td_top td_bottom td_left td_right"><input type="text" name="school" size="50">
</td></tr>
<tr style="font-family:tahoma,sans-serif,arial; font-size:12px; font-weight:bold;">
<td class="td_top td_bottom td_left td_right" align="right">Latitude :</td>
<td class="td_top td_bottom td_left td_right"><input type="text" name="longitude" size="30" id="longitude">
</td></tr>
<tr style="font-family:tahoma,sans-serif,arial; font-size:12px; font-weight:bold;">
<td class="td_top td_bottom td_left td_right" align="right">Longitude :</td>
<td class="td_top td_bottom td_left td_right"><input type="text" name="latitude" size="30" id="latitude">
</td></tr>
</table>
<div id="authors"></div>
<table width="100%" cellpadding="1" cellspacing="0">
